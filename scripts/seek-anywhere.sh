#!/bin/sh
# TODO: youtube videos increment playback while manually paused, must track player status and store last_pos and maintain internal position for such players
DELTA="$1"
